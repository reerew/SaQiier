...
●━━━━━━━━●
    ...
    {str(eee)}''')
                    if "A wait of" in str(eee):
                        ...
                        await fifthon.send_message(event.chat.id, " حاج اجاك متاح !")
            else:
                pass
            trys += 1
        ...
        isclaim.append("off")
        trys = ""
        await event.client.send_message(event.chat_id, "!حاج انتهى الصيد")
...
●━━━━━━━━●
    ...
    {str(eee)}''')
            ...
            isclaim.clear()
            isclaim.append("off")
            await fifthon.send_message(event.chat_id, "انتهى التثبيت حاج")
